...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $errors = array_merge($errors, validate_budget_input($conn, $userId, $categoryId, $amount, $month, $year));
    ...
    if (empty($errors)) {
        db_execute(
            ...
            'iidii',
            [$userId, $categoryId, normalize_decimal($amount), $month, $year]
        );
...
<main class="app-main">
    <div class="container">
        <div class="budget-card app-card p-4">
            <h1 class="page-title h3 mb-1">Add Budget</h1>
            <p class="text-muted mb-4">Set a monthly limit for one expense category.</p>
            ...
            <?php if (empty($categories)) { ?>
                <div class="alert alert-warning">Create at least one expense category before adding budgets.</div>
                <a class="btn btn-outline-secondary" href="<?php echo e(app_url('categories/create.php')); ?>">Add Category</a>
            <?php } else { ?>
                <form method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="row g-3">
                    ...
                    <div class="d-flex flex-wrap gap-2 mt-4">
                        ...
                        <a class="btn btn-outline-secondary" href="<?php echo e(app_url('budgets/index.php')); ?>">Cancel</a>
                    </div>
                </form>
            <?php } ?>
        </div>
